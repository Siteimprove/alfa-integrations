...
- **Changed:** Update Alfa ([#443](https://github.com/Siteimprove/alfa-integrations/pull/443))
...
- **Changed:** Update Alfa. ([#323](https://github.com/Siteimprove/alfa-integrations/pull/323))
...
- **Changed:** Update Alfa ([#241](https://github.com/Siteimprove/alfa-integrations/pull/241))
...
- **Changed:** Update Alfa. ([#205](https://github.com/Siteimprove/alfa-integrations/pull/205))

## 0.80.5

### Patch Changes

- **Changed:** Update Alfa ([#192](https://github.com/Siteimprove/alfa-integrations/pull/192))
...
- **Changed:** Invoke `chalk` directly instead of the `alfa-highlight` deprecated wrapper. ([#58](https://github.com/Siteimprove/alfa-integrations/pull/58))
